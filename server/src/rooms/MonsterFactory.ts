import { MonsterCard } from "./schema/MonsterCard";
...
export class MonsterFactory {
   ...
   *    ■
   */
  static createBat(id: string): MonsterCard {
    const bat = new MonsterCard(id, "bat", 5, 4);
   ...
   *   ■■■
   */
  static createGoblin(id: string): MonsterCard {
    const goblin = new MonsterCard(id, "goblin", 3, 4);
   ...
   *    ■
   */
  static createRat(id: string): MonsterCard {
    const rat = new MonsterCard(id, "rat", 4, 3);
   ...
   *  ■■■■■
   */
  static createTroll(id: string): MonsterCard {
    const troll = new MonsterCard(id, "troll", 5, 5);
   ...
   *   ■■■
   */
  static createSlime(id: string): MonsterCard {
    const slime = new MonsterCard(id, "slime", 5, 3);
